...
class SequentialMemory(Memory):
    def __init__(self, num_limit, **kwargs):
        ...
        self.actions = RingBuffer(num_limit)
        self.rewards = RingBuffer(num_limit)
        self.terminals = RingBuffer(num_limit)
        self.observations = RingBuffer(num_limit)
    ...
    def get_config(self):
        ...
        config['num_limit'] = self.num_limit
        return config
...
class EpisodeParameterMemory(Memory):
    def __init__(self, num_limit, **kwargs):
        ...
        self.params = RingBuffer(num_limit)
        self.intermediate_rewards = []
        self.total_rewards = RingBuffer(num_limit)
